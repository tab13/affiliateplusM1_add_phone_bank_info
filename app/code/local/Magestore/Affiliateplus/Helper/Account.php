...
class Magestore_Affiliateplus_Helper_Account extends Mage_Core_Helper_Abstract {
    ...
    //hainh 22-07-2014
    public function createAffiliateAccount($address, $paypalEmail, $customer, $notification, $referringWebsite, $successMessage, $referredBy=null, $coreSession=null, $keyShop, $telephone = null) {
