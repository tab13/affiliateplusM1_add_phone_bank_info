...
class Magestore_Affiliateplus_Block_Adminhtml_Account_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('telephone', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Telephone'),
            'name' => 'telephone',
            'class' => 'required-entry',
            'required' => true,
        ));
        ...
        $fieldset->addField('key_shop', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Key Shop'),
            'name' => 'key_shop',
            'class' => 'required-entry',
            'required' => true,
        ));
