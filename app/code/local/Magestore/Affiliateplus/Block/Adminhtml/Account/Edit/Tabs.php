...
class Magestore_Affiliateplus_Block_Adminhtml_Account_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		...
		// //tab
		$this->addTab('bankaccount_section', array(
			'label'     => Mage::helper('affiliateplus')->__('Bank Account Information'),
			'title'     => Mage::helper('affiliateplus')->__('Bank Account Information'),
			'content'   => $this->getLayout()->createBlock('affiliateplus/adminhtml_account_edit_tab_bankaccountinfo')->toHtml(),
		));
		// //end tab
